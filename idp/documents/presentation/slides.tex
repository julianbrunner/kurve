...
\begin{document}
	...
	\section{Problem Analysis}
		...
		\begin{frame}
			...
			\center{\includegraphics[width=\textwidth]{../content/common/examples_bezier.pdf}}\\
		...
		\begin{frame}
			...
			\center{\includegraphics[width=\textwidth]{../content/common/examples_spiro.pdf}}\\
	...
	\section{Proposed Solution}
		...
		\begin{frame}
			...
			\center{\includegraphics[width=\textwidth]{../content/common/description-based_curves.pdf}}\\
		\end{frame}
		...
		\begin{frame}
			...
			\center{\includegraphics[width=\textwidth]{../content/presentation/specification_example.pdf}}\\
		\end{frame}

		% A
		\begin{frame}
			\frametitle{Fairness Measure}
			\center{\includegraphics[width=\textwidth]{../content/presentation/fairness_measures.pdf}}
		...
		\begin{frame}
			...
			\begin{itemize}
				\item segmentation
			\end{itemize}
			\center{\includegraphics[width=\textwidth]{../content/common/linear_segmentation.pdf}}
		...
		\begin{frame}
			...
			\end{itemize}
			\center{\includegraphics[width=50mm]{../content/presentation/inverse_covered_arc_length.pdf}}
			\begin{itemize}
	...
	\section{Implementation}
		...
		\begin{frame}
			...
			\center{\includegraphics[width=35mm]{../content/presentation/optimization_step_dag.pdf}}\\
		\end{frame}
