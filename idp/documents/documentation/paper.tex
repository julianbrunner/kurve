...
\begin{document}
		...
		\label{section:description_language}
			...
			\label{section:fairness_measure}
				...
				\begin{figure}[htbp]
					...
					\caption{Minimum Energy Curve Examples. Point specification items are represented as red dots, direction specification items are represented as green tangent lines.}
				...
				\begin{figure}[htbp]
					...
					\caption{Minimum Variation Curve Examples. Point specification items are represented as red dots, direction specification items are represented as green tangent lines.}
	...
	\label{section:evaluation}
		...
		\label{section:examples}
			...
			Figure \ref{figure:examples_prototype} shows some examples of curves designed using the prototype curve design tool. Point specification items are represented using red dots, direction specification items are represented using green tangent lines and curvature specification items are represented using blue circular arcs taken from the osculating circle.
