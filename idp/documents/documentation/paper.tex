...
\begin{document}
	...
	\label{section:evaluation}
		...
		\label{section:examples}
			...
			Figure \ref{figure:examples_prototype} shows some examples of curves designed using the prototype curve design tool. Point specification items are displayed as red dots, direction specification items are displayed green tangent lines and curvature specification items are displayed using blue circular arcs taken from the osculating circle.
