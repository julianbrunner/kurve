...
\begin{document}
	...
	\label{section:problem_analysis}
		...
		\label{section:existing_curve_design_tools}
			...
			\label{section:bézier_splines}
				...
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/common/examples_bezier.pdf}
			...
			\label{section:spiro_splines}
				...
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/common/examples_spiro.pdf}
	...
	\label{section:proposed_solution}
		...
		\label{section:description-based_curves}
			...
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=\textwidth]{../content/common/description-based_curves.pdf}
		...
		\label{section:description_language}
			...
			\label{section:fairness_measure}
				...
				% TODO: fairness measure integral is over the arc length of the curve
				% TODO: mention that mvc facilitates describing circular arcs and spirals (constant and linearly changing curvature)
				% TODO: MEC cannot handle curvature specifications
				% TODO: add some illustrations, describe their general behaviour, smoothness
				...
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/documentation/fairness_mec.pdf}
				...
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/documentation/fairness_mvc.pdf}
		...
		\label{section:curve_derivation}
			...
			\label{section:segmentation_notation}
				...
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=100mm]{../content/common/linear_segmentation.pdf}
			...
			\label{section:final_assembly}
				...
				% TODO: sketch overall curve derivation process similar to the summary slide
	...
	\section{Implementation}
		...
		\subsection{Architecture}
			...
			\subsubsection{Subsystem Decomposition}	
				...
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/documentation/subsystems.pdf}
		...
		\section{Numerical Optimization}
			...
			\subsection{Specification}
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/documentation/specification_class_diagram.pdf}
			...
			\subsection{Optimization}
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/documentation/optimization_class_diagram.pdf}
		...
		\section{User Interface}
			\subsection{Implementation}
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/documentation/ui_components_class_diagram.pdf}
			...
			\subsection{Usage}
				...
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/documentation/ui_components.pdf}
				...
				\begin{figure}[htbp]
					\centering
					\includegraphics[width=\textwidth]{../content/documentation/ui_speeds.pdf}
	...
	\label{section:evaluation}
		...
		\label{section:usability_analysis}
			...
			\label{section:smoothness_minimality_curves_selected_fairness_measure}
				...
				% TODO: expand, figure out what to write here and in the section about the fairness measure
		...
		\label{section:examples}
			...
			\begin{figure}[htbp]
				\centering
				\includegraphics[width=\textwidth]{../content/common/examples_prototype.pdf}
				\caption{Prototype Curve Design Tool Examples (left: Fluttershy \cite{fluttershy})}
				\label{figure:examples_prototype}
			\end{figure}

			% TODO: add illustration to section introducing specification language, add reference to it here
