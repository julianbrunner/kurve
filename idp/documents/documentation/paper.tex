		...
		\subsection{Architecture}
			...
			\subsection{User Interface Implementation}
				...
				\begin{itemize} 
					...
					\item \verb|RootComponent| - The \verb|RootComponent| manages a list of \verb|CurveComponent|s and implements functionality to add and remove curve components. Additionally, the RootComponent implements save and load functionality.
					...
					\item \verb|FixedPositionComponent| - \verb|FixedPositionComponent|s represent the start and end of a CurveComponent.
					\item \verb|SegmentComponent| - A \verb|SegmentComponent| represents a section of a curve delimited by two PositionedControlComponents. The SegmentComponent renders the curve in that segment, but it also allows to modify the length of the curve in that segment.
