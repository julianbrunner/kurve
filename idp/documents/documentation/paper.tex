		...
		\label{section:description_language}
			...
			\label{section:fairness_measure}
				...
				\begin{figure}[htb]
					...
					\end{subfigure}
					\caption{Minimum Energy Curve Examples. Point specification items are displayed as red dots, direction specification items are displayed as green tangent lines.}
					\label{figure:minimum_energy_curve_examples}
				\end{figure}

				Figure \ref{figure:minimum_energy_curve_examples} shows a few examples of minimum energy curves under various constraints. Note the characteristic shape of the MEC (rectangular elastica), as well as the fact that, in absence of direction or curvature specification items, its curvature is always zero at the endpoints.
				...
				\begin{figure}[htb]
					...
					\end{subfigure}
					\caption{Minimum Variation Curve Examples. Point specification items are displayed as red dots, direction specification items are displayed as green tangent lines.}
					\label{figure:minimum_variation_curve_examples}
				\end{figure}

				Figure \ref{figure:minimum_variation_curve_examples} shows a few examples of minimum variation curves under the same constraints as the curves in figure \ref{figure:minimum_energy_curve_examples}. Note that instead of segments from the rectangular elastica, the MVC's characteristic shapes are circular arcs and spirals. One may also observe that, instead of trying to bring the curvature to zero towards the endpoints like the MEC does, the MVC tries to establish constant curvature. In contrast to the MEC, the MVC constructs a circular arc in the leftmost example and avoids the inflection point in the rightmost example.
	...
	\label{section:evaluation}
		...
		\label{section:examples}
			...
			\begin{figure}[htb]
				...
				\end{subfigure}
				\caption{Examples of curves designed using the prototype curve design tool. Point specification items are displayed as red dots, direction specification items are displayed green tangent lines and curvature specification items are displayed using blue circular arcs taken from the osculating circle.}
