	...
	\label{section:proposed_solution}
		...
		\label{section:nonlinear_optimization_polynomial_curves}
			...
			\subsubsection{Specification Language}
				...
				%   point, direction and curvature
				%   some kind of position specification (ideally, arc-length) is needed for non-points (even points aren't optimal without as they can slide)
				% maybe just leave out the whole justification with segmentation, etc. and just assume arc-length parametrization
			...
			\subsubsection{Segmentation and Parametrization}
				...
				\begin{table}[htb]
					...
					\begin{tabular}{c|c|r|r|}
						\multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{2}{c}{Segmentation Visibility} \\
						\cline{2-4}
						& Scenario & \multicolumn{1}{|c|}{Exposed} & \multicolumn{1}{|c|}{Opaque} \\
						\cline{2-4}
						\multirow{2}{*}{Position Specification} & Default & 1 & 2 \\
						\cline{2-4}
						& Arc-Length & 3 & 4 \\
						\cline{2-4}
					\end{tabular}
					\caption{Choices for Position Specification and Segmentation Visibility}
					\label{table:choices_position_specification_segmentation_visibility}
				\end{table}

			\subsubsection{Disambiguation Information}
