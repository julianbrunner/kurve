		...
		\section{User Interface}
			...
			\subsection{Usage}
				...
				\label{section:specification_control}
					...
					To achieve more fine-grained control, it is possible to press the alt key while performing any of the actions described above. This changes the affected property of the specification control more slowly. For exa^mple, if you press alt while dragging a specification control, it will move very slowly.
