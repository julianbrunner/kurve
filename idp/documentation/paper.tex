	...
	\label{section:evaluation}
		...
		\label{section:usability_analysis}
			...
			\label{section:expressiveness_description_language}
				...
				% TODO: mention that using the description (not specification) language, one can now specify linearly increasing curvature
		...
		\label{section:examples}
			...
			%     since point specifications occur only at the start and end of the curve, there is no danger of introducing unintentional bumps in the middle of the curve
		...
		\label{section:verdict}
			...
			% usability of the prototype curve design tool is still bad, but that may not mean the description language is useless, maybe there are better ways than optimization to derive curves from descriptions and to fulfill criterion 6 better
