...
\begin{document}
	...
	\label{section:proposed_solution}
		...
		\label{section:description_language}
			...
			The human visual system seems to be fairly insensitive to properties beyond the third derivative of the curve, that is, beyond variation of curvature. Based on that premise, we chose to let the user specify properties up to the second derivative of the curve using the specification language, while designing the fairness measure to choose curves whose third derivative is minimal from the set of curves that fulfill the specification's requirements.
